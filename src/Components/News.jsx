...
export default class News extends Component {
  ...
  async componentDidMount() {
    console.log("cdm");
    console.log("pageSize prop:", this.props.pageSize); // Add this to debug
    let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=691ae3a452b043a2b9d10ae52d8ef9c7&page=1&pageSize=${this.props.pageSize}`;
    this.setState({loading: true});
    let data = await fetch(url);
    let parsedData = await data.json();
    console.log("Fetched articles count:", parsedData.articles.length); // Add this to check fetched count
    this.setState({
      articles: parsedData.articles,
      totalResults: parsedData.totalResults,
      loading: false
    }); // it will update the articles in state with the articles from parsedData
  }
  ...
  handlePrevClick = async () => {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=691ae3a452b043a2b9d10ae52d8ef9c7&page=${
      this.state.page - 1
  ...
  render() {
    return (
      <div className="container my-3">
       ...
       {this.state.loading && <div className="d-flex justify-content-center"><div className="spinner-border" role="status"><span className="visually-hidden">Loading...</span></div></div>}
        <div className="row">
